...
public class IdentifiableCastFunction<E extends Identifiable> extends CastFunction<E> {

	public IdentifiableCastFunction(Class<? extends E> clazz){
		super(clazz);
	}
